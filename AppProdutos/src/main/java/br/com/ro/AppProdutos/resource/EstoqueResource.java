package br.com.ro.AppProdutos.resource;
...
import br.com.ro.AppProdutos.service.EstoqueService;
...
public class EstoqueResource {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Optional<Estoque>> delete(@PathVariable Long id) {
